...
global CFG
    ...
    config( 5, [   1,     0,    0   ]); %     Euler mode: 0 - normal, 1 - extended, 2 - power test, 3 - Mu(Uc) test
    config( 6, [   0,    120,   1   ]); % UGeneratorType: "const."[-1,V,?], "sinus"[0,V,*2πf], "rectangle": [ 2,Vmax,0 ][2,120,0]
    config( 7, [   5,    0.8,   0   ]); % MjMode: "const" [0,value], [1..]-Vander [2]-Sklejane 1st [3]-apr. wielomian 3st [4]-apr 5 stopnia [5] FIXED -1000,1000
         UGen();
      MuBuild();
    end    
end
