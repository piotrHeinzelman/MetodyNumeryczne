...
global CFG
    ...
    config( 6, [   0,    240,   2   ]); % UGeneratorType: "const."[-1,V,?], "sinus"[0,V,*2πf], "rectangle": [ 2,Vmax,0 ][2,120,0]
    config( 7, [   2,    0.8,   0   ]); % MjMode: "const" [0,value], [1..]-Vander [2]-Sklejane 1st [3]-apr. wielomian 3st [4]-apr 5 stopnia
         UGen();
      MuBuild();
    end    
end
